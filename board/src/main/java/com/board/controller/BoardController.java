...
public class BoardController {
	...
	//미니 게시판 등록(GET)--> 입력 화면 보기
	@RequestMapping(value = "/write", method = RequestMethod.GET)
	public String getWrite(HttpSession session) throws Exception {
	...
	public String getMView(HttpSession session, Model model, @RequestParam(name="seqno", required=false) int seqno, 
	...
	public List<ReplyVO> postReply(ReplyVO vo, @RequestParam("option") String option) throws Exception {
		...
		mReplyData = service.replylist(vo.getSeqno());
	...
	public String getModify(HttpSession session, Model model, @RequestParam(name="seqno", required=false) int seqno,
			@RequestParam(name="num",required=false) int num, 
			@RequestParam(name="searchType", defaultValue="title", required=false) String searchType, 
			@RequestParam(name="keyword", defaultValue="", required=false) String keyword
			) throws Exception {
	...
	public String postModify(Model model, BoardVO vo,
			@RequestParam(name="num",required=false) int num, 
			@RequestParam(name="searchType", defaultValue="title", required=false) String searchType, 
			@RequestParam(name="keyword", defaultValue="", required=false) String keyword
			) throws Exception {
	...
	public String postDelete(Model model, @RequestParam(name="seqno", required=false) int seqno,
		...
		return "redirect:/board/list?num=" + Integer.toString(num);	
